...
public class UsersRepositoryJdbcTemplateImpl implements UsersRepository {
    ...
    private static final String SQL_SELECT_ONE_BY_ID = "select * from account where id = ? limit 1";
    ...
    public User findById(Long id) {
        try {
            return jdbcTemplate.queryForObject(SQL_SELECT_ONE_BY_ID, USER_ROW_MAPPER, id);
